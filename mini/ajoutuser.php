...
if(isset( $_GET['email']))
{	$req="INSERT INTO utilasateurs (idu,nom,email,mdp)values(null,'{$_GET['email']}','{$_GET['email']}','{$_GET['psw']}')" ;
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card">
            <form action='ajoutuser.php' method='GET'class="box">
...
<p><input type="submit"class="signupbtn"value="Ajouter"/></p>
<p><b></p>

                </form>
                </form>
                <form action="admin.php">
<p><button  >Retour page Admin</p>
</button>

...
<div class="carousel-indicators">
  ...
  <div class="carousel-inner">
   ...
   <img src="images/111.jpg" style="width:1226px; height:400px;" />
   ...
   <img src="images/2222.jpg" style="width:1226px; height:400px;" />
    ...
    <div class="carousel-item">
<img src="images/3333.jpg" style="width:1226px; height:400px;" />  
...
if(isset($_GET['btnsubmit'])){
	$mc=$_GET['motcle'];
$reqselect="select * from puzz where pname like '%{$mc}%'";}
else{
            $query = "SELECT * FROM  puzz ORDER BY id ASC ";

...
<i class="bi bi-person-fill"><h3></h3></i></a></p>';
        ...
        <?php
        if (isset($_SESSION['user'])){
	echo "<h1 >Bienvenue à RoBoKits {$_SESSION['user']}</h1>";
...
<h1 class="text-center"> L'avenir c'est nous </h1>
...
<div class="row featurette">
  <div class="col-md-7">
    <h1 class="featurette-heading">Wooden kits</span></h1>
    <p class="lead"><h3> Un wooden Robot c'est un Super Robot à assembler sois-même c'est parfait et les pièces sont faciles à assembler;
       Robokits HR est une société tunisienne, jeune et dynamique à l'image des passionnés des montages manuels.</br>
...
soi-même ou en famille, sans colle, à l'aide d'un guide de montage détaillé, facile et clair pour vivre des moments de partages.
  ...
  <div class="col-md-5">
<img src="images/2222.JPG" style="width:336px; height:200px;">
...
<div class="row featurette">
  <div class="col-md-7 order-md-2">
    <h1 class="featurette-heading">Robotique <span class="text-muted"></span></h1>
...
Si vous le souhaitez, vous pouvez vous tourner vers des puzzles en bois en 3D représentant des thèmes spécitiques.
La robotique est un secteur d'activité comprenant l'étude, la conception et la fabrication de robots ou machines automatisées. Pour être considérée comme un robot, une machine doit être pourvue de capteurs, qui analysent l'environnement.
</h3></div>
  <div class="col-md-5 order-md-1">
  <img src="images/rl.jpg" style="width:400px; height500px;">
  </div>
</div>
...
<div class="row featurette">
  <div class="col-md-7">
    ...
    <h1 class="featurette-heading">Puzz<span class="text-muted"></span></h1>
...
soi-même ou en famille, sans colle, à l'aide d'un guide de montage détaillé, facile et clair pour vivre des moments de partages.
  ...
  <div class="col-md-5">
  <img src="images/7.JPG" style="width:336px; height:200px;">
...
<hr class="featurette-divider">
        ...
        <video width="1200" height="500" autoplay loop controls >
